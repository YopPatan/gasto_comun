...
-- Dump data of "boleta" -----------------------------------
INSERT INTO `boleta`(`id`,`cuenta_id`,`folio`,`monto`,`adjunto`,`fecha`) VALUES ( '1', '7', '1111', '1111', '1111', '2018-01-04 18:08:11' );
INSERT INTO `boleta`(`id`,`cuenta_id`,`folio`,`monto`,`adjunto`,`fecha`) VALUES ( '2', '7', '1111', '1111', '1111', '2018-01-04 18:08:11' );
-- ---------------------------------------------------------
...
INSERT INTO `cuenta`(`id`,`nombre`,`tipo`) VALUES ( '4', 'test1', '0' );
INSERT INTO `cuenta`(`id`,`nombre`,`tipo`) VALUES ( '5', 'test3', '0' );
INSERT INTO `cuenta`(`id`,`nombre`,`tipo`) VALUES ( '6', 'test5', '0' );
INSERT INTO `cuenta`(`id`,`nombre`,`tipo`) VALUES ( '7', 'test10', '0' );
INSERT INTO `cuenta`(`id`,`nombre`,`tipo`) VALUES ( '8', 'test 14', '1' );
-- ---------------------------------------------------------
...
INSERT INTO `personal_item`(`id`,`nombre`,`monto`,`tipo`,`personal_id`) VALUES ( '1', 'AFP Habitat Comision', '10', '2', '3' );
INSERT INTO `personal_item`(`id`,`nombre`,`monto`,`tipo`,`personal_id`) VALUES ( '2', 'AFP Habitat Fondo', '12', '2', '3' );
INSERT INTO `personal_item`(`id`,`nombre`,`monto`,`tipo`,`personal_id`) VALUES ( '3', 'Impuesto unico', '40000', '2', '3' );
INSERT INTO `personal_item`(`id`,`nombre`,`monto`,`tipo`,`personal_id`) VALUES ( '4', 'Isapre Banmedia', '128000', '2', '3' );
INSERT INTO `personal_item`(`id`,`nombre`,`monto`,`tipo`,`personal_id`) VALUES ( '5', 'Sueldo Bruto', '900000', '1', '3' );
INSERT INTO `personal_item`(`id`,`nombre`,`monto`,`tipo`,`personal_id`) VALUES ( '6', 'Movilizacion', '30000', '1', '3' );
-- ---------------------------------------------------------
...
-- CREATE INDEX "lnk_liquidacion_item_personal_item" -------
CREATE INDEX `lnk_liquidacion_item_personal_item` USING BTREE ON `liquidacion_item`( `personal_item_id` );
-- ---------------------------------------------------------


-- CREATE INDEX "lnk_null_personal_contable_liquidacion" ---
CREATE INDEX `lnk_null_personal_contable_liquidacion` USING BTREE ON `personal_pago`( `liquidacion_id` );
-- ---------------------------------------------------------


-- CREATE INDEX "lnk_personal_contable_personal" -----------
CREATE INDEX `lnk_personal_contable_personal` USING BTREE ON `personal_pago`( `personal_id` );
-- ---------------------------------------------------------
