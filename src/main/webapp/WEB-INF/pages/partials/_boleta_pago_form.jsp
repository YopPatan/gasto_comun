...
<div class="modal fade" id="boletaPagoForm" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                <form:form action="/cuenta/${cuentaId}/boleta/save" id="boletaForm">
                    ...
                    <div class="form-group row">
                        <label for="boleta_pago_fecha" class="col-sm-2 col-form-label col-form-label-sm">Fecha</label>
                        <div class="col-sm-10">
                            <input type="date" class="form-control form-control-sm" id="boleta_pago_fecha" name="boleta_adjunto" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="boleta_pago_monto" class="col-sm-2 col-form-label col-form-label-sm">Monto</label>
                        <div class="col-sm-10">
