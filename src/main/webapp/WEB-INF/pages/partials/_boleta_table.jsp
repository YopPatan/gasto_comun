...
<table class="table table-sm-aux">
    ...
    <c:forEach var="boleta" items="${boletas}" varStatus="loop">
        <tr>
            ...
            <td>${boleta.folio}</td>
            <td>${boleta.monto}</td>
            <td>${boleta.adjunto}</td>
            <td></td>
            <td><a href="/cuenta/${cuenta.id}/boleta/edit/${boleta.id}" class="btn btn-outline-info btn-sm-aux"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
