        ...
        <table class="table table-sm-aux">
            ...
            <c:forEach var="personalItem" items="${personalItemHaberes}" varStatus="loop">
                <tr>
                    ...
                    <td width="50"><button onclick="loadPersonalItemModal('/personal/${personal.id}/item/edit/${personalItem.id}')" class="btn btn-outline-info btn-sm-aux"><i class="fa fa-pencil" aria-hidden="true"></i></button></td>
                    <td width="50"><a href="/personal/${personal.id}/item/delete/${personalItem.id}" class="btn btn-outline-info btn-sm-aux"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                </tr>
            </c:forEach>
