...
<div class="row">
    <div class="col-sm-6">
        <table class="table table-sm-aux">
            ...
            <tr>
                <th scope="col" colspan="5">Haberes Imponibles</th>
            </tr>
            </thead>
            <tbody>

            <c:forEach var="personalItem" items="${personalItemImponibles}" varStatus="loop">
                <tr>
        ...
        <table class="table table-sm-aux">
            <thead class="thead-dark">
            <tr>
                <th scope="col" colspan="5">Haberes No Imponibles</th>
            </tr>
            </thead>
            <tbody>

            <c:forEach var="personalItem" items="${personalItemNoImponibles}" varStatus="loop">
                <tr>
                    <th width="50" scope="row" style="text-align: center">${loop.index + 1}</th>
                    <td>${personalItem.nombre}</td>
                    <td align="right">
