            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="${personalPago.adjunto}" class="form-control form-control-sm" id="personal_pago_adjunto" name="personal_pago_adjunto" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="personal_pago_monto" class="col-sm-3 col-form-label col-form-label-sm">Monto</label>
                        <div class="col-sm-9">
                            <input value="${personalPago.monto}" class="form-control form-control-sm" id="personal_pago_monto" name="personal_pago_monto" required />
                        </div>
                    </div>
                </div>
