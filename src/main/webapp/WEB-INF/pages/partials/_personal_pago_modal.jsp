...
<div class="modal fade" id="personalPagoModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form:form action="/personal/${personal.id}/pago/save" id="personalItemForm">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="personal_item_nombre" class="col-sm-4 col-form-label col-form-label-sm">Fecha</label>
                        <div class="col-sm-8">
                            <input type="date" value="${personalItem.nombre}" class="form-control form-control-sm" id="personal_item_nombre" name="personal_item_nombre" />
                        </div>
                    </div>
                    <div class="form-group row">
